...
function JobsClientPage({ initialLiveJobs, searchParams }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (loggedIn && user.id) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAppliedJobs"])(user.id, searchParams.search).then((jobs)=>setAppliedJobs(jobs)).catch((err)=>console.error("Failed to load applied jobs", err));
        }
    }, [
        searchParams.search
...
//# sourceMappingURL=app_3ee634cb._.js.map