...
"[project]/app/api/jobs/[id]/apply/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/crypto [external] (crypto, cjs)"); // Native Node module
;
;
;
async function POST(request, { params } // 1. Type as Promise
) {
    // 2. Await the params
    ...
    const existing = db.applications.find((app)=>app.jobId === jobId && app.userId === userId);
    if (existing) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newApplication);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__cafc5ed5._.js.map